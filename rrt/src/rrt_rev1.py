...
class RRT():
    ...
    def build(self):
        ...
        for k in range(self.max_iter):
            ...
            print("Nearest_neigh:", neighbor)
            new_node = self._extend_sample(sample, neighbor)
            print("nw node:", new_node)
    ...
    def _get_nearest_neighbor(self, sample):
        ...
        for i in nodelist:
            distance = np.linalg.norm(i.state - sample)
    ...
    def _extend_sample(self, sample, neighbor):
        ...
        if np.linalg.norm(sample - neighbor.state) < self.step_size:
            ...
            if self._check_for_collision(sample) == None:
            ...
            if self._check_for_collision(n_near) == None:
    ...
    def _check_for_collision(self, sample):
        ...
        # obj2 = CollisionSphere([0, 0], 1)
        # if obj1.in_collision(sample) and obj2.in_collision(sample):
        #     return True
        # else:
        #     return False
...
#     sample = rrt._get_random_sample()
#     print(sample)
#     neighbor = rrt._get_nearest_neighbor(sample)
#     print(neighbor)
#     print(rrt._extend_sample(sample, neighbor))
